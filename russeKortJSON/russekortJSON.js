...
//når funksjonen kjøres byttes russekortet fra blått til rødt
function blaa() {
...
//bytter fra rødt kort til blått
function rod() {
...
//bruker databasen for å sjekke hvor mange elementer det er for å legge inn i som et option i inputen
for (let element in russeKort.personer) {
    maler.innerHTML += "<option>" + russeKort.personer[element].navn + "</option>";
}

//legger inn all informasjonen til personen som er valgt, det er -1 fordi det er lagt inn et option som heter
// velg person som da tar opp en plass i selectedIndex. Og tallet skal kjøres med databasen, uten -1 vil 
// det være personen etter den valgte personen som kommer opp
